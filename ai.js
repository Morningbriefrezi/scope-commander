...
🎨 ვიზუალის აღწერა — რა ფოტო/ვიდეო გადაიღო
#️⃣ ჰეშთეგები — 15-25 ცალი (ქართული + ინგლისური მიქსი)
⏰ საუკეთესო დრო გამოსაქვეყნებლად
💬 CTA — კითხვა ან მოწოდება ჩართულობისთვის

საკვანძო სიტყვები: ${cat.keywords.join(', ')}

ყველაფერი ქართულად! არ გამოიყენო სხვა ენა ტექსტში.`;
